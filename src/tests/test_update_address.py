...
if operation_status == OPER_UPDATE_SUCCEEDED:
    print(f'Updated address: {updated_street} {updated_number} {updated_flat_number} {updated_zip_code} {updated_city} {updated_country} is in the database')
elif operation_status == OPER_UPDATE_FAILED_DATA_NOT_FOUND:
    print(f'Updated address: {updated_street} {updated_number} {updated_flat_number} {updated_zip_code} {updated_city} {updated_country} is not in the database')
