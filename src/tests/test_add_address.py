...
if operation_status == OPER_ADD_SUCCEEDED:
    print(f"Address: {street} {number} {flat_number} {zip_code} {city} {country} was added to the database")
elif operation_status == OPER_ADD_FAILED_DATA_EXISTS:
    print(f"Address: {street} {number} {flat_number} {zip_code} {city} {country} is already in the database")